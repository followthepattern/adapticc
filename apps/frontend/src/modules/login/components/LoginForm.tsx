...
const LoginForm = () => {
  return (
    <Form className="max-w-md xs:w-full">
      ...
      <Form.Submit className="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Login</Form.Submit>
    </Form>
  );
};
