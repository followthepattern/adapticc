...
func ModelToSQLMockRows(value interface{}) *sqlmock.Rows {
...
func getSqlItemType(value interface{}) reflect.Type {
...
func getSingleSqlItemValue(value interface{}) reflect.Value {
	ttype := reflect.TypeOf(value)
...
func getSqlItemValueByIndex(value interface{}, index int) reflect.Value {
	ttype := reflect.TypeOf(value)
	vvalue := reflect.ValueOf(value)
...
func getSqlRowCount(value interface{}) int {
	ttype := reflect.TypeOf(value)
	vvalue := reflect.ValueOf(value)
